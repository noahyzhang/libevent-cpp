#ifndef LIBEVENT_CPP_REQUEST_H
#define LIBEVENT_CPP_REQUEST_H
...
public:
    ...
    inline void set_remote_port(const unsigned short remote_port) {
...
private:
    ...
    std::string uri_; 
    unsigned short http_major_version_ = 1; // http 的主版本号，例如 http1.0 中的 1
    unsigned short http_minor_version_ = 1; // http 的副版本号，例如 http1.0 中的 0 
